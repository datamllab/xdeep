...
def test_bp():
  ...
  image_path = 'tests/xlocal_gradient/images/ILSVRC2012_val_00000073.JPEG'
  ...
  visualize(norm_image, output, save_path='tests/xlocal_gradient/results/GuidedBP_' + image_name)
